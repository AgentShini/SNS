import SendEventMessage from "./SendEventMessages"
...
export default function EventMessages(){
   const {eventmessagesReceived, setEventMessagesReceived, activeUser} = useContext(DataContext)
...
// Remove event listener on component unmount
  ...
  {eventmessagesReceived.length === 0 ? (
   ...
   <SendEventMessage/>
    ...
    <div className="chat-grid">
      {eventmessagesReceived.map((msg, i) => (
        <div
